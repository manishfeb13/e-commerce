...
items = [
  ...
  {product:'White Pants', price: 2399, img: 'https://www.snitch.co.in/cdn/shop/files/4MSR5043-01-3214.jpg?v=1700222542', tags: ['comfort', 'skinny-fit', 'breathable', 'stretch'],description:'Experience the comfort with our selection of formal pants. Whether you are looking for a slim fit or a classic straight leg, we have plenty of options to fulfil your style needs. Browse through pants for men in materials like linen and cotton blended with elastane.'},
  ...
  {product:'Blue Jeans', price: 1999, img: 'https://www.snitch.co.in/cdn/shop/files/4MSD3601-02-3218.jpg?v=1689153684', tags: ['comfort', 'skinny-fit', 'breathable', 'stretch'],description:'Experience the comfort with our selection of formal pants. Whether you are looking for a slim fit or a classic straight leg, we have plenty of options to fulfil your style needs. Browse through pants for men in materials like linen and cotton blended with elastane.'},
...
openAddToCartDialog(item:any){
  ...
  dialogRef.afterClosed().subscribe(result =>{
    console.log(`Quantity Ordered: ${result}`)
  })
}
